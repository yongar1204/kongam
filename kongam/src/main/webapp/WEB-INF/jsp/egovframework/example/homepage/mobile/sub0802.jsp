                ...
                <section id="platform-1">
                    ...
                    <div class="cont-1">
                        <h3 class="basic-title" id="stream-1">
                            ...
                            <span class="txt">CCTV방범체계부터 산불감시, 항만감시, 저수지 범람 등 다양한 재난상황을<span class="br"></span>
                                실시간으로 분석하는 지능형 통합 재난 관제기술과 날씨정보, 지리정보시스템 등을<span class="br"></span>
                                연계하여 지자체, 학교시설 등 다양한 관리주체가 재난 위협을 효과적으로<span class="br"></span>
                                모니터링 및 판단하는 예측 및 공동대응기법을 적용한<span class="br"></span>
                                <b>강력한 재난관리 연계시스템</b>입니다.
                            </span>
                        </h3>
                        <div class="c-wrap">
                            <ul class="stream-group">
                                <li data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="500" data-aos-anchor="#stream-1"> <span>영상데이터 디바이스</span> </li>
                                <li data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="700" data-aos-anchor="#stream-1"> <span>영상데이터 수집 및 저장</span> </li>
                                <li data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="900" data-aos-anchor="#stream-1"> <span>영상데이터 통합관리</span> </li>
                                <li data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="1100" data-aos-anchor="#stream-1"> <span>서비스제공</span> </li>
                            </ul>
                        </div>
                    </div>             
                    <!-- cont-2 -->
                    <div class="cont-2 " id="stream-2">
                        ...
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="1000" data-aos-delay="1500" data-aos-anchor="#stream-2"> <img src="/resources/mobile/images/sub/platform-1-c1-2.jpg" alt="영상 데이터 업로드, 상황에 따른 영상 모드 지원 연관이미지" /> </div>
                    ...
                    <div class="cont-3" id="stream-3">
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="800" data-aos-delay="800" data-aos-anchor="#stream-3"> <img src="/resources/mobile/images/sub/platform-1-c1-3.jpg" alt="intoUs Stream 연관이미지" /> </div>
                            ...
                            <div class="text-box">
                                <dl data-aos="fade-up"  data-aos-duration="500" data-aos-delay="1300" data-aos-anchor="#stream-3">
                                    ...
                                    <dd>HTML5 Player를 지원하는 라이브러리를 사용함으로써 다양한 플러그인 지원이 가능</dd>
                ...
                <section id="platform-2">
                    ...
                    <div class="cont-1">
                        <h3 class="basic-title"  data-aos="fade-up" data-aos-delay="500">
                            ...
                            <span class="txt">실시간 데이터처리 및 사물인터넷 기술을 적용한 최적화된 시스템으로<span class="br moVer"></span>
                            <b>실시간 장애 및 수요예측기능을 제공</b>합니다.
                            </span>
                        </h3>
                        <div class="c-wrap">
                            <ul class="stream-group">
                                <li data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="500" data-aos-anchor="#platform-2"> <span>센서 디바이스</span> </li>
                                <li data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="700" data-aos-anchor="#platform-2"> <span>센서 수집 및 저장</span> </li>
                                <li data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="900" data-aos-anchor="#platform-2"> <span>센서데이터 통합관리</span> </li>
                                <li data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="1100" data-aos-anchor="#platform-2"> <span>서비스제공</span> </li>
                            </ul>
                        </div>
                    </div>             
                    <!-- cont-2 -->
                    <div class="cont-2 " id="IoT-2">
                        ...
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="1000" data-aos-delay="1500" data-aos-anchor="#IoT-2"> <img src="/resources/mobile/images/sub/platform-2-c2-1.jpg" alt="다양한 데이터 수집 기능, 실시간 위치정보 및 추적기능 제공 지원 연관이미지" /> </div>
                            ...
                            <div class="text-box">
                                <dl data-aos="fade-up"  data-aos-duration="500" data-aos-delay="2000" data-aos-anchor="#IoT-2">
                                    <dt>다양한 데이터 수집 기능</dt>
                                    <dd class="noBul">IoT 센서 등 실시간 자료 수집 지원 및 이기종 타시스템의 온오프라인 데이터 수집 기능, Global Standard 연계 기술 적용</dd>
                                </dl>
                                <dl data-aos="fade-up"  data-aos-duration="500" data-aos-delay="2100" data-aos-anchor="#IoT-2">
                                    <dt>실시간 위치정보 및 추적기능 제공</dt>
                                    <dd class="noBul">사람, 자산, 차량 등의 실시간 위치파악 및 이동경로 추적 위치분석 및 주요 부착 센서의 실시간 모니터링</dd>
                                </dl>
                            </div>
                        </div>
                    </div>      
                    ...
                    <div class="cont-3" id="IoT-3">
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="800" data-aos-delay="800" data-aos-anchor="#IoT-3"> <img src="/resources/mobile/images/sub/platform-2-c3-1.jpg" alt="intoUs IoT 연관이미지" /> </div>
                            ...
                            <div class="text-box">
                                <dl data-aos="fade-up"  data-aos-duration="500" data-aos-delay="1300" data-aos-anchor="#IoT-3">
                                    ...
                                    <dd class="noBul">다양한 IoT Controller를 통한 Remote Command 실행 및 제어 기능 제공 및 IoT Controller를 통한 Actuator 제어</dd>
                                </dl>
                                <dl data-aos="fade-up"  data-aos-duration="500" data-aos-delay="1400" data-aos-anchor="#IoT-3">
                                    <dt>데이터 통합 모니터링 기능 제공</dt>
                                    <dd class="noBul">다양한 IoT Senser 및 장비로부터의 데이터 수집, Enterprise 내 다양한 Business Application 표준 인터페이스 제공</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <section id="platform-3">
                    ...
                    <div class="cont-1">
                        <h3 class="basic-title"  data-aos="fade-up" data-aos-delay="500">
                            ...
                            <span class="txt">스마트시티 플랫폼은 다양한 도시상황 관리 및 스마트도시 통합운영센터 운영을 위한 핵심기술인 기반 소프트웨어로 지자체 도시관제센터에서<span class="br moVer"></span>
                                <b>방범, 방재, 교통, 시설물 정보 시스템을 연계하여 활용</b>합니다.
                            </span>
                        </h3>
                        <div class="c-wrap" id="sCity-1">
                            <ul class="sCity-group">
                                <li class="sCg-1"> 
                                    <div class="item" data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="700" data-aos-anchor="#sCity-1">
                                        <span>교통</span>
                                        <i></i>
                                    </div> 
                                    <div class="item" data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="1000" data-aos-anchor="#sCity-1">
                                        <span>방범</span>
                                        <i></i>
                                    </div> 
                                    <div class="item" data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="1300" data-aos-anchor="#sCity-1">
                                        <span>환경</span>
                                        <i></i>
                                    </div> 
                                </li>
                                ...
                                <li class="sCg-3"> 
                                    <div class="item" data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="1800" data-aos-anchor="#sCity-1">
                                        <i></i>
                                        <span>통합관제</span>
                                    </div> 
                                    <div class="item" data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="2100" data-aos-anchor="#sCity-1">
                                        <i></i>
                                        <span>모니터링</span>
                                    </div> 
                                    <div class="item" data-aos="fade-down"  data-aos-duration="500"  data-aos-delay="2400" data-aos-anchor="#sCity-1">
                                        <i></i>
                                        <span>GIS 서비스</span>
                                    </div> 
                                </li>
                    ...
                    <div class="cont-2 " id="sCity-2">
                        ...
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="1000" data-aos-delay="1500" data-aos-anchor="#sCity-2"> <img src="/resources/mobile/images/sub/platform-3-c2-1.jpg" alt="통합환경 기능 제공, 독자적인 기술 적용 연관이미지" /> </div>
