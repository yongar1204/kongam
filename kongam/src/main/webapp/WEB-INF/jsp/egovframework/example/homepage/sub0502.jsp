    ...
    <div class="wrap">
        ...
        <div id="tabbar">
            <div class="button-group w_33">
                ...
                <button class="tablinks active" onClick="location.href='/recruits/benefits.do'">복리후생</button>
        ...
        <section class="sub-contents" id="recruit-area">
            <div class="content">                
                <div id="recruit02-wrap" class="tabcontent_tab" style="display: block;">
                    ...
                    <ul>
                        <li>
                            <div><img src="/resources/images/recruit04.png" alt="시계아이콘"></div>
                            <strong>근무시간</strong>
                            <ul>
                        ...
                        <li>
                            <div><img src="/resources/images/recruit05.png" alt="화분아이콘"></div>
                        ...
                        <li>
                            <div><img src="/resources/images/recruit06.png" alt="스마일아이콘"></div>
                            <strong>경조사</strong>
                            <ul>
                        ...
                        <li>
                            <div><img src="/resources/images/recruit07.png" alt="브레인아이콘"></div>
                            <strong>교육지원</strong>
                            <ul>
                                <li>자기개발 도서구입비 지원</li>
                        ...
                        <li>
                            <div><img src="/resources/images/recruit08.png" alt="컴퓨터아이콘"></div>
                            <strong>업무환경</strong>
                            <ul>
                        ...
                        <li>
                            <div><img src="/resources/images/recruit09.png" alt="자동차아이콘"></div>
                            <strong>교통지원</strong>
                            <ul>
                                <li>야간근무 교통비 지급</li>
                            </ul>
                        ...
                        <li>
                            <div><img src="/resources/images/recruit10.png" alt="집아이콘"></div>
