...
<html lang="ko">
			...
			<section class="section">
				<div class="mainSlide">
					<div class="ms-cont ms-1">
						<div class="txt">
							<h3>공감아이티는<br /><b>혁신과 신뢰의 가치를 높이고</b></h3>
					...
					<div class="ms-cont ms-3">
						<div class="txt">
							...
							<p>리더 중심의 의사결정시스템과 자기주도적 문제해결을<br />학습강화로 서비스 불만을 해소와 개인의 역량을 향상합니다.</p>
							<div class="img-box">
								<div class="ib-wrap">
									<i class="ib-1"></i>
									<i class="ib-2"></i>
				...
				<div class="contentArea first">
					<div class="ca-cont">
						<div class="txt">
								...
								<div class="btn-wrap"> <a href="/bigdata.do" class="btn-arrow" ><span>자세히보기</span></a> </div>								
						</div>
                        <div class="img"> <img src="resources/images/2022/cs-img-1.jpg" alt="관련이미지" /> </div>
					</div>
                </div>
            </section>
            <section class="section">
				<div class="contentArea second">
					<div class="ca-cont">
						<div class="txt">
								...
								<div class="btn-wrap"> <a href="/platform.do" class="btn-arrow" ><span>자세히보기</span></a> </div>								
						</div>
                        <div class="img"> <img src="resources/images/2022/cs-img-2.jpg" alt="관련이미지" /> </div>
					</div>
                </div>
            </section>
            <section class="section">
					...
					<div class="ca-cont">
						<div class="txt">
								<h3>
									...
									<span class="ani-txt"><span><b>GIS 솔루션 사업</b></span></span>
								</h3>
								<p>
									<span class="ani-txt"><span>공감아이티의 수 많은 현장 중심 노하우를 바탕으로</span></span>
									<span class="ani-txt"><span>사용자 맞춤 GIS 솔루션을 제공합니다.</span></span>
								</p>
								<div class="btn-wrap"> <a href="/gis.do" class="btn-arrow" ><span>자세히보기</span></a> </div>								
						</div>
                        <div class="img"> <img src="resources/images/2022/cs-img-3.jpg" alt="관련이미지" /> </div>
					</div>
                </div>
            </section>
			<section class="section">
				<div class="mainNews">
					<div class="mn-wrap">
						<div class="tit">
							...
							<div class="btn-wrap"> <a href="/board/list.do" class="btn-arrow" ><span>자세히보기</span></a> </div>
						</div>
						<div class="cont">
							<c:forEach var="Post" items="${recentPost}">
								<a href="/board/${ Post.boardIdx }.do" class="boxHover">
 ...
 <script src="/resources/js/mobile/detectmobilebrowser.js"></script>
 <script>
