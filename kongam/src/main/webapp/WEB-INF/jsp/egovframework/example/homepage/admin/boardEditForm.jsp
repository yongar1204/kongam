            ...
            <div class="content">
                ...
                <form id="board-form">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="tBox">
                                    ...
                                    <input type="text" id="Input-1" name="title" autocomplete="off" value="${ post.title }" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="taBox">
                                    ...
                                    <textarea id="content" name="content" cols="20" rows="20" >${ post.content }</textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <ul class="file-add">
                                	...
                                	<c:forEach var="file" items="${ fileMapList }">
                                		<li id="${ file.fileIdx }">${ file.orgFileName }<button class="fileDelete" type="button" title="삭제"><i class="ico-close"></i>삭제</button></li>
                                	</c:forEach>
                    ...
                    <div class="linkArea center">
                    	<button type="button" class="grey boardDelete">삭제</button>
                        <button type="button" class="grey boardSubmit">수정</button>
                        <button type="button" class="grey boardCancel" onclick="location.href='/admin/board/list.do'">취소</button>
                    </div>
                </form>
                <!-- 게시판 + 등록 : E  -->
            </div>
...
<script>
        ...
        $("input[type=file]").change(function () {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                $('.file-add').append(
                    ...
                    "' class='attfile'>"
                    +file.name+
                    "<button class=\"fileDelete\" type=\"button\" title=\"삭제\"><i class=\"ico-close\"></i>삭제</button></li>"
                )
            }
        });
    })
    ...
    $('.fileDelete').click(function(){
    	var fileIdx = this.parentElement.id;
    	fileDeleteList.push(fileIdx)
    	this.parentElement.remove();
    })
    
    $('.boardDelete').click(function () {
    	var bIdx = window.location.pathname.split("/")[4]
    	$.ajax({
    ...
    $('.boardSubmit').click(function () {
        ...
        async function sendData(){
            ...
            console.log(fileArr)
            objects.fileDeleteList = fileDeleteList;
            $.ajax({
                url: '/admin/board/edit/' + bIdx,
                type: 'POST',
