    ...
    <div class="wrap">
        ...
        <div id="tabbar">
            <div class="button-group w_25">
                <button class="tablinks active" onClick="location.href='/mobile/companies/index.do'">인사말</button>
            ...
            <div id="greeting_2022" class="tabcontent_scroll">
                <div class="content">
                    ...
                    <div class="greeting-visual">
                        <p>empathy for<br />
                            other people’s<br />
                            <span>공감아이티는 사람의 소중한 가치를 최우선으로하는 공감아이티는<br />
                                사람중심의 경영을 통한 탁월함과 감성비즈니스로<br />
                                최고의 기업가치를 창출하겠습니다.</span>
                        </p>
                        <!-- <img src="./images/2022/greeting-visual.jpg" alt="empathy for other people’s - 공감아이티는 사람의 소중한 가치를 최우선으로하는 공감아이티는 사람중심의 경영을 통한 탁월함과 감성비즈니스로 최고의 기업가치를 창출하겠습니다." /> -->
                    </div>
                    <div class="greeting-text"data-aos="fade-right">
                        ...
                        <p>㈜공감아이티는 고객, 직원, 조직과의 공감ㆍ 소통을 중요시하는 정보기술 서비스 전문기업 입니다. <br />
                            ...
                            <br />
                            공간정보를 활용한 독보적인 GIS분야 자체 기술을 보유하고 있으며,<span class="br"></span>
                            끊임없는 연구 개발과 기술혁신을 통해 고객에게 최고의 가치를 제공할 수 있도록 노력하고 있습니다. <br />
                            <br />
                            사람과 기술 중심의 경영철학을 바탕으로 초심을 잃지 않고<span class="br"></span>
                ...
                <div class="content">
                    <div class="greeting-copy" data-aos="fade-up" >
                        <p>올바른 IT서비스를 위해<br /><span>우리는 오늘도 <b>Creation!!</b></span></p>
                    </div>
                </div>
            </div>
        </section>
