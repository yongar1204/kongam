    ...
    <div class="wrap">
        ...
        <div id="tabbar">
            <div class="button-group w_25">
                ...
                <button class="tablinks active" onClick="location.href='/companies/org.do'">조직도</button>
            ...
            <div id="organization_2022" class="tabcontent_scroll">
                <div class="content">
                    ...
                    <div class="organization">
                        ...
                        <div class="og-item-3">
                            <dl class="list" data-aos="fade-up-right" data-aos-delay="300">
                            ...
                            <dl class="list" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <dl class="list" data-aos="fade-up" data-aos-delay="500">
