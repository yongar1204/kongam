    ...
    <div class="wrap">
        ...
        <div id="tabbar">
            <div class="button-group w_33 disabled" >
				<button class="tablinks disabled" onClick="location.href='/recruits/index.do';">인사제도</button>
                <button class="tablinks disabled" onClick="location.href='/recruits/benefits.do';">복리후생</button>
                <button class="tablinks disabled" onClick="location.href='/recruits/board.do';">채용안내/공고</button>
            </div>
        </div>
                ...
                <article class="table-detail-01">
                    ...
                    <ul class="board-pagination">
                        <li class="prev"> 
                            ...
                            <a href="/" class="webkitBox">제9회 지방자치의 날 유공자 정부포상 후보자 공모</a>
                            <span class="num pcVer">2021-07-09</span>
                        </li>
                        <li class="next"> 
...
<script src="/resources/js/2022/recruits-board-details.js"></script>
</html>