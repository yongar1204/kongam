        ...
        <section class="sub-contents">
                ...
                <section id="bigData-1">
                    ...
                    <div class="cont-1">
                        <h3 class="basic-title">
                            ...
                            <span class="txt">Data Governance 구축에 필요한 데이터 연계 수집, 적재, 표준, 품질관리 등<span class="br"></span>
                                전 과정에 필요한 S/W를 통합하여 솔루션 및 서비스를 제공하는<span class="br moVer"></span>
                                <b>데이터 통합 연계 플랫폼</b>입니다.
                            </span>
                        </h3>
                        <div class="img-box" id="bigData-c1"> <img src="/resources/mobile/images/sub/bigData-1-c1-1.png" alt="intoUs 제품 목업 이미지" data-aos="fade-up" data-aos-delay="300"  /> </div>
                        <div class="bg-box"  > <img src="/resources/mobile/images/sub/bigData-1-c1-2.png" alt="intoUs 제품 소개 백그라운드 패턴"  data-aos="zoom-in"  data-aos-duration="500" data-aos-anchor="#bigData-c1"/> </div>
                    </div>
                    <!-- cont-2 -->
                    <div class="cont-2 " id="bigData-c2">
                        ...
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="1000" data-aos-delay="1500" data-aos-anchor="#bigData-c2"> <img src="/resources/mobile/images/sub/bigData-1-c2-1.jpg" alt="기능적합성, 성능 효율성 연관이미지" /> </div>
                                <i class="mi-bg" data-aos="zoom-in-down"  data-aos-duration="500" data-aos-delay="1000" data-aos-anchor="#bigData-c2"></i>
                            </div>
                            <div class="text-box">
                                ...
                                <dl data-aos="fade-up"  data-aos-duration="500" data-aos-delay="2100" data-aos-anchor="#bigData-c2">
                                    ...
                                    <dd>메시지큐의 독립적인 운영으로 특정 인터페이스의 부하 폭주에도 타 인터페이스 안정적인 처리</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cont-3" id="bigData-c3">
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="800" data-aos-delay="800" data-aos-anchor="#bigData-c3"> <img src="/resources/mobile/images/sub/bigData-1-c3-1.jpg" alt="이식성, 유지보수성 연관이미지" /> </div>
                    ...
                    <div class="cont-4 " id="bigData-c4">
                        ...
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="800" data-aos-delay="1500" data-aos-anchor="#bigData-c4"> <img src="/resources/mobile/images/sub/bigData-1-c4-1.jpg" alt="보안성, 사용성 연관이미지" /> </div>
                ...
                <section id="bigData-2">
                    ...
                    <div class="cont-1">
                        <h3 class="basic-title" data-aos="fade-up" data-aos-delay="500">
                            ...
                            <span class="txt">다양한 이질적 환경을 통합하여 하나의 시스템으로 관리 및 운영할 수 있는<span class="br"></span>
                                유기적인 기술로써 표준 사양을 기반으로 구성되어 있으며<span class="br moVer"></span>
                                요구사양이 바뀌어도 <b>쉽게 대응할 수 있는 유연성</b>이 있습니다.
                            </span>
                        </h3>
                        <div class="esb-group">
                            <div class="c-wrap">
                                <div class="eg-1"  id="ESB-1">
                                    <ul class="items">
                                        <li data-aos="fade-right"  data-aos-duration="500" data-aos-delay="1200" data-aos-anchor="#ESB-1"><b>DB</b> 연동방식</li>
                                        <li data-aos="fade-right"  data-aos-duration="500" data-aos-delay="1400" data-aos-anchor="#ESB-1"><b>FTP</b> 연동방식</li>
                                    </ul>
                                    <div class="visual"  data-aos="zoom-in-up"  data-aos-duration="500" data-aos-delay="1000" data-aos-anchor="#ESB-1">
                                        <span>연계기관</span>
                                        <img src="/resources/mobile/images/sub/bigData-2-c1-1.png" alt="연계기관 아이콘" />
                                    </div>
                                    <ul class="items">
                                        <li data-aos="fade-left"  data-aos-duration="500" data-aos-delay="1600" data-aos-anchor="#ESB-1"><b>HTTP</b> 연동방식</li>
                                        <li data-aos="fade-left"  data-aos-duration="500" data-aos-delay="1800" data-aos-anchor="#ESB-1"><b>Socket</b> 연동방식</li>
                                    </ul>
                                </div>
                                <div class="arrow" data-aos="fade-down"  data-aos-duration="500" data-aos-delay="2900" data-aos-anchor="#ESB-1"> <img src="/resources/mobile/images/sub/bigData-2-c1-3.png" alt="화살표 아이콘" /> </div>
                                <div class="eg-2">
                                    <ul class="items">
                                        <li data-aos="fade-right"  data-aos-duration="500" data-aos-delay="2200" data-aos-anchor="#ESB-1"><b>데이터접속</b> 서비스</li>
                                        <li data-aos="fade-right"  data-aos-duration="500" data-aos-delay="2400" data-aos-anchor="#ESB-1"><b>운영</b> 서비스</li>
                                    </ul>
                                    <div class="visual"  data-aos="zoom-in-up"  data-aos-duration="500" data-aos-delay="2000" data-aos-anchor="#ESB-1">
                                        <span>연계서버</span>
                                        <img src="/resources/mobile/images/sub/bigData-2-c1-2.png" alt="연계서버 아이콘" />
                                    </div>
                                    <ul class="items">
                                        <li class="vertical" data-aos="fade-left"  data-aos-duration="500" data-aos-delay="2600" data-aos-anchor="#ESB-1"><b>애플리케이션</b>서비스</li>
                                        <li data-aos="fade-left"  data-aos-duration="500" data-aos-delay="2800" data-aos-anchor="#ESB-1"><b>중계</b> 서비스</li>
                                    </ul>
                                </div>
                    ...
                    <div class="cont-2 " id="ESB-2">
                        ...
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="800" data-aos-delay="1500" data-aos-anchor="#ESB-2"> <img src="/resources/mobile/images/sub/bigData-2-c2-1.jpg" alt="보안성, 사용성 연관이미지" /> </div>
                ...
                <section id="bigData-3">
                    ...
                    <div class="cont-1">
                        <h3 class="basic-title" data-aos="fade-up" data-aos-delay="500">
                            ...
                            <span class="txt">Spring Integration FrameWork를 사용하여 성능과 안정성을 보장하고<span class="br"></span>
                        ...
                        <div class="c-wrap">
                            <div class="etl-group" data-aos="zoom-in" data-aos-anchor="#bigData-3"  data-aos-duration="500"  data-aos-delay="1300">
                                ...
                                <ul >
                                    <li data-aos="fade-down" data-aos-anchor="#bigData-3"  data-aos-duration="500"  data-aos-delay="1500">
                                        <img src="/resources/mobile/images/sub/bigData-3-c1-1.png" alt="Extract 아이콘" />
                                        <span>
                                            <b>Extract</b>
                                            <p>Data Source 1</p>
                                        </span>
                                    </li>
                                    <li class="arrow" data-aos="fade-down" data-aos-anchor="#bigData-3"  data-aos-duration="500"  data-aos-delay="1700"> 
                                        <img src="/resources/mobile/images/sub/bigData-3-c1-4.png" alt="화살표 아이콘 "/> 
                                    </li>
                                    <li data-aos="fade-down" data-aos-anchor="#bigData-3"  data-aos-duration="500"  data-aos-delay="1900">
                                        <img src="/resources/mobile/images/sub/bigData-3-c1-2.png" alt="Extract 아이콘" />
                                        <span>
                                            <b>Transform</b>
                                            <p>Transformation Engine</p>
                                        </span>
                                    </li>
                                    <li class="arrow" data-aos="fade-down" data-aos-anchor="#bigData-3"  data-aos-duration="500"  data-aos-delay="2100"> 
                                        <img src="/resources/mobile/images/sub/bigData-3-c1-4.png" alt="화살표 아이콘 "/> 
                                    </li>
                                    <li data-aos="fade-down" data-aos-anchor="#bigData-3"  data-aos-duration="500"  data-aos-delay="2300">
                                        <img src="/resources/mobile/images/sub/bigData-3-c1-3.png" alt="Extract 아이콘" />
                                        <span>
                                            <b>Load</b>
                                            <p>Target</p>   
                                        </span>
                    ...
                    <div class="cont-2 " id="bigData-3-c2">
                        ...
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="1000" data-aos-delay="1500" data-aos-anchor="#bigData-3-c2"> <img src="/resources/mobile/images/sub/bigData-3-c2-1.jpg" alt="시스템의 확장, 시스템 안정성 보장 연관이미지" /> </div>
                ...
                <section id="bigData-4">
                    ...
                    <div class="cont-1">
                        <h3 class="basic-title" data-aos="fade-up" data-aos-delay="500">
                            ...
                            <span class="txt">데이터의 신뢰성을 보장하는 <b>AI 기계학습 알고리즘 지원</b>이 가능한<span class="br"></span>
                                <b>데이터 품질관리 3.0 기반</b> 데이터 유형에 따라,<span class="br"></span>
                                필요한 원시데이터·데이터 가공·데이터 활용 및 유형별 품질관리와<span class="br"></span>
                                데이터구축 과정 품질관리를 위한<span class="br"></span>
                                획득·정제·가공·품질검수 등을 포함합니다.
                            </span>
                        </h3>
                        <div class="c-wrap">
                            <div class="img-box"> 
                                <img src="/resources/mobile/images/sub/bigData-4-c1-4.png" alt="intoUs QM/MM 설명이미지" data-aos="fade-down" data-aos-delay="2000"  id="bigData-4"  />
                                <img src="/resources/mobile/images/sub/bigData-4-c1-1.png" alt="intoUs QM/MM 설명이미지" data-aos="fade-up" data-aos-duration="800" data-aos-delay="1500"  id="bigData-4"/>
                            </div>
                            <div class="bg-box"  > 
                                <img src="/resources/mobile/images/sub/bigData-4-c1-2.png" alt="intoUs QM/MM 백그라운드 패턴"  data-aos="fade-right"  data-aos-duration="500" data-aos-delay="1000" data-aos-anchor="#bigData-4"/> 
                                <img src="/resources/mobile/images/sub/bigData-4-c1-3.png" alt="intoUs QM/MM 백그라운드 패턴"  data-aos="fade-left"  data-aos-duration="500" data-aos-delay="1300" data-aos-anchor="#bigData-4"/> 
                            </div>
                        </div>
                    ...
                    <div class="cont-2 " id="QM-2">
                        ...
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="800" data-aos-delay="1500" data-aos-anchor="#QM-2"> <img src="/resources/mobile/images/sub/bigData-4-c2-1.jpg" alt="데이터 품질향상, 다양한 플랫폼, 편리한 데이터정비 연관이미지" /> </div>
                    ...
                    <div class="cont-3" id="QM-3">
                        <div class="c-wrap">
                            <div class="visual-box">
                                ...
                                <div class="main-img" data-aos="fade-up"  data-aos-duration="800" data-aos-delay="800" data-aos-anchor="#QM-3"> <img src="/resources/mobile/images/sub/bigData-4-c3-1.jpg" alt="머신러닝 적용, 데이터 매칭, 규칙기반 품질측정 연관이미지" /> </div>
            ...
            <article class="brochure">
                <div class="container" data-aos="fade-up"  data-aos-duration="1000" data-aos-delay="1000">
                    ...
                    <img src="/resources/mobile/images/sub/brochure_logo.png" alt="인투어스 로고" />
                    <button type="button" onclick="location.href='/intousppt/downLoad.do'">제품소개서 다운로드</button>
                </div>
                <div class="img-box" data-aos="slide-down"  data-aos-duration="1000" data-aos-delay="500"> <img src="/resources/mobile/images/sub/brochure_bg_icon.png" alt="제품소개서 다운로드 배경 아이콘" /> </div>
                <div class="bg-box" data-aos="zoom-out" data-aos-duration="3000"> <img src="/resources/mobile/images/sub/brochure_bg.jpg" alt="제품소개서 다운로드 배경 이미지" /> </div>
            </article>
        </section>
        <footer id="footer">
