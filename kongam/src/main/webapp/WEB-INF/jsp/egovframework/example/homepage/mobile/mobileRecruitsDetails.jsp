    ...
    <div class="wrap">
        ...
        <div id="tabbar">
            <div class="button-group w_33 disabled" >
				<button class="tablinks disabled" onClick="location.href='/mobile/recruits/index.do';">인사제도</button>
                <button class="tablinks disabled" onClick="location.href='/mobile/recruits/benefits.do';">복리후생</button>
                <button class="tablinks disabled" onClick="location.href='/mobile/recruits/board.do';">채용안내/공고</button>
            </div>
        </div>
