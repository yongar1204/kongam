    ...
    $(document).ready(function (){
        ...
        $.ajax({
            ...
            success : function (result){
                ...
                if(!result.pre){
                	 $('.board-pagination').append("<li class='prev'><span><i class='ico-arrow'></i> 이전글 </span><a href='#' class='webkitBox'>이전글이 없습니다<span class = 'num' pcVer></span></li>");
                } else{
                ...
                if(!result.next){
                	$('.board-pagination').append("<li class='next'><span><i class='ico-arrow'></i> 다음글 </span><a href='#' class='webkitBox'>다음글이 없습니다<span class = 'num' pcVer></span></li>");
                } else{
