    ...
    $(document).ready(function (){
        ...
        $.ajax({
            ...
            success : function (result){
                ...
                $('.board-pagination').append("<li class='prev'><span><i class='ico-arrow'></i> 이전글 </span><a href='/mobile/board/" + result.pre.boardIdx + ".do' class='webkitBox'>"
                ...
                if(!result.next){
                	...
                	$('.board-pagination').append("<li class='next'><span><i class='ico-arrow'></i> 다음글 </span><a href='/mobile/board/" + result.next.boardIdx + ".do' class='webkitBox'>"
                ...
                $('#listLink').attr('href', function(){
                	if(result.category_name == 'NOTICE'){
                		return '/mobile/board/list/notice.do'
                	} else if(result.category_name == 'NEWS'){
                		return '/mobile/board/list/news.do'
                	} else if(result.category_name == 'ACTIVITY'){
                		return '/mobile/board/list/activity.do'
                	} else {
                		return '/mobile/recruits/board.do'
                	}
